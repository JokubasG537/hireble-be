...
router.post("/", authMiddleware, authorizeRole("recruiter", "admin"), companyController.createCompany);
router.get("/",  companyController.getAllCompanies);
router.get("/:id", authMiddleware, authorizeRole("recruiter", "admin"), companyController.getCompanyById);
